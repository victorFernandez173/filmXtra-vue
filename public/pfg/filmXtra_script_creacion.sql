...
(
    ...
    CONSTRAINT obras_titulo_unique UNIQUE (titulo),
    CONSTRAINT duracion CHECK (`duracion` > 0)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE = utf8mb4_unicode_ci;
...
(
    ...
    CONSTRAINT evaluaciones_obra_id_foreign FOREIGN KEY (obra_id) REFERENCES obras (id) ON DELETE CASCADE,
    CONSTRAINT evaluaciones_user_id_foreign FOREIGN KEY (user_id) REFERENCES users (id) ON DELETE CASCADE,
    CONSTRAINT evaluacion CHECK (`evaluacion` > 0)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE = utf8mb4_unicode_ci;
