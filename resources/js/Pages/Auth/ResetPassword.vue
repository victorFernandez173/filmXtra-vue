            ...
            <div class="w-full p-6 bg-white shadow md:mt-0 sm:max-w-md sm:p-8">
                ...
                <form class="mt-4 space-y-4 lg:mt-5 md:space-y-5" @submit.prevent="submit">
                    ...
                    <div>
                        ...
                        <TextInput type="password"  id="confirm-password" placeholder="••••••••" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-flamingo focus:border-flamingo block w-full p-2.5" v-model="form.password_confirmation" />
