                    ...
                    <form class="space-y-4 md:space-y-6" @submit.prevent="submit">
                        ...
                        <div>
                            ...
                            <TextInput
                                ...
                                class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-flamingo  block w-full p-2.5"
                                v-model="form.email"
                                autofocus
                        ...
                        <div class="flex items-center justify-end">
                            <Link
                                ...
                                class="text-sm text-gray-800 hover:text-flamingo rounded-md focus:outline-none focus:border-[2px] focus:border-flamingo border-[2px] border-white active:text-gray-800"
                            >
                                ¿Contraseña olvidada?
                            </Link>
                        </div>
                        ...
                        <div class="flex justify-around">
                            ...
                            <a :href="route('auth.google')" type="button" class="text-white bg-[#4285F4] hover:bg-flamingo hover:font-extrabold hover:text-[#4285F4] focus:ring-4 focus:outline-none focus:ring-[#4285F4]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center">
