            ...
            <div class="w-[95%] bg-white shadow md:mt-0 sm:max-w-md xl:p-0">
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form class="space-y-4 md:space-y-6" @submit.prevent="submit">
                        <!--             Correo electrónico               -->
                        <div>
                            <input-label for="email" :value="$t('login.email_label')" class="block mb-2 text-sm font-medium text-gray-900" />
                            <text-input
                                id="email"
                        ...
                        <!--             Contraseña               -->
                        <div>
                            <input-label for="password" :value="$t('login.password_label')" class="mb-2 text-sm font-medium text-gray-900 inline-block" />&nbsp;
