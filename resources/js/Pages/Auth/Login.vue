                ...
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form class="space-y-4 md:space-y-6" @submit.prevent="submit">
                        ...
                        <p class="text-right text-sm font-light text-gray-700">
                            ¿Aún no tienes cuenta? <Link :href="route('register')" class="font-medium text-primary-600 hover:text-flamingo focus:outline-none focus:border-[2px] focus:border-flamingo border-[2px] border-white">¡Regístrate aquí!</Link>
                        </p>
                    </form>
                </div>
            </div>
