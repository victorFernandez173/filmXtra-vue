...
<template>
    ...
    <auth-layout>
        <div class="py-32 flex flex-col items-center h-fit">
            ...
            <div :class="$page.props.auth.user.login_tipo_id === 1 && $page.props.auth.user.email_verificado_fecha ? 'lg:grid-cols-2' : 'lg:grid-cols-1'" class="w-full lg:w-fit grid grid-cols-1 mb-16 p-4 sm:p-8 bg-white text-center justify-items-center">
