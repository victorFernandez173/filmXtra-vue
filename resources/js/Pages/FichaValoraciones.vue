...
const form = useForm({
    user_id: '',
    obra_id: '',
    critica: cargarContenidoCriticaUsuario(page.props.auth.user ? page.props.auth.user.id : null, page.props.obra.id),
});
// Evaluación
const form2 = useForm({
    user_id: '',
...
const existeLaEvaluacionBandera = ref(comprobarSiExisteLaEvaluacion(page.props.auth.user ? page.props.auth.user.id : null, page.props.obra.id));
...
const existeLaCriticaBandera = ref(comprobarSiExisteLaCritica(page.props.auth.user ? page.props.auth.user.id : null, page.props.obra.id));
                    ...
                    <form
                        ...
                        <div class="w-full">
                            <SelectRango class="w-2/5 sm:w-1/4 md:w-3/4 text-center" :limite="11"
                                         :valor="cargarContenidoEvaluacionUsuario(page.props.auth.user.id, page.props.obra.id) ? cargarContenidoEvaluacionUsuario(page.props.auth.user.id, page.props.obra[0]['id']) : 'Nota'"
