        ...
        <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
            <div
                ...
                <div>
                    ...
                    <ul class="text-gray-500 font-medium hover:[&>li]:text-flamingo hover:[&>li]:no-underline">
                        <li class="mb-4">
                ...
                <div>
                    ...
                    <ul class="text-gray-500 font-medium">
                        ...
                        <li>
                            <p class="px-12 sm:px-0 hover:text-flamingo">Explora un mundo de emociones y sorpresas en FilmXtra,
            ...
            <span class="text-sm text-gray-500 sm:text-center">© 2023 <Link class="hover:text-flamingo"
                ...
                <div class="hover:[&>a]:text-flamingo flex justify-center mt-4 space-x-6 sm:margin-auto sm:mt-0">
                    ...
                    <a href="https://www.instagram.com/" target="_blank" class="text-gray-500">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                            <path fill-rule="evenodd"
                    ...
                    <a href="https://twitter.com/home" target="_blank" class="text-gray-500 ">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                            <path
                    ...
                    <a href="https://github.com/victorFernandez173/filmXtra-vue" target="_blank" class="text-gray-500">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                            <path fill-rule="evenodd"
