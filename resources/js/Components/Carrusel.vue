...
<template>
    ...
    <div id="default-carousel" class="relative w-full" data-carousel-interval="7000" data-carousel="slide">
        ...
        <div class="fotos relative h-56 overflow-hidden md:h-96 [&>div>div>div>p]:text-gray-800 [&>div>div>div>p]:text-center">
            ...
            <div class="hidden duration-700 ease-in-out" data-carousel-item>
                <img src="/images/carrusel1.jpg"
                     class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2 z-49"
        ...
        <div class="absolute z-30 flex space-x-3 -translate-x-1/2 bottom-3 left-1/2">
            ...
            <button type="button" class="w-3 h-3 rounded-full bg-gray-800/30" aria-current="false" aria-label="Slide 3"
                    data-carousel-slide-to="2"></button>
            <button type="button" class="w-3 h-3 rounded-full bg-gray-800/30" aria-current="false" aria-label="Slide 4"
                    data-carousel-slide-to="3"></button>
            <button type="button" class="w-3 h-3 rounded-full bg-gray-800/30" aria-current="false" aria-label="Slide 5"
                    data-carousel-slide-to="4"></button>
            <button type="button" class="w-3 h-3 rounded-full bg-gray-800/30" aria-current="false" aria-label="Slide 6"
                    data-carousel-slide-to="5"></button>
            <button type="button" class="w-3 h-3 rounded-full bg-gray-800/30" aria-current="false" aria-label="Slide 7"
                    data-carousel-slide-to="6"></button>
            <button type="button" class="w-3 h-3 rounded-full bg-gray-800/30" aria-current="false" aria-label="Slide 8"
        ...
        <button type="button"
                ...
                data-carousel-prev>
          <span
              class="inline-flex items-center justify-center w-8 h-8 rounded-full sm:w-10 sm:h-10 bg-gray-800/30 group-hover:bg-white/50 group-focus:ring-4 group-focus:ring-white group-focus:outline-none">
