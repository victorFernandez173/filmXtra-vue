...
<template>
    <div class="flex justify-center mt-2 flex-wrap w-[100%]">
        <!-- Estrella -->
        <div class="flex items-center my-2 text-yellow-300 m-auto text-2xs">
            <svg aria-hidden="true" class="w-[1.20rem] h-[1.20rem] xl:w-7 xl:h-7"
            ...
            <!-- Valoraciones -->
            <p v-if="mostrarVotos" class="text-black text-xs sm:text-base ml-1">
                {{ mediaEvaluaciones }}/10
                ({{ obra.evaluaciones.length }}
            </p>
            <svg v-if="mostrarVotos" class="w-4 h-4 sm:w-5 sm:h-5 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                <path fill-rule="evenodd" d="M12 4a4 4 0 1 0 0 8 4 4 0 0 0 0-8Zm-2 9a4 4 0 0 0-4 4v1a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2v-1a4 4 0 0 0-4-4h-4Z" clip-rule="evenodd"/>
            </svg>
            <p v-if="mostrarVotos" class="text-black text-xs sm:text-base">
                )
            </p>
        </div>
    </div>
