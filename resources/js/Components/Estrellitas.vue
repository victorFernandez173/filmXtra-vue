...
<template>
    <div class="flex justify-center mt-2 flex-wrap w-[100%]">
        <!-- Estrella -->
        <div class="flex items-center mt-2 text-yellow-300 m-auto text-2xs">
            <svg aria-hidden="true" class="w-4 h-4 md:w-5 md:h-5 lg:w-7 lg:h-7"
            ...
            <!-- Valoraciones -->
            <p v-if="mostrarVotos" class="text-black text-xs lg:text-base">
                {{ mediaEvaluaciones }}/10
                ({{ obra.evaluaciones.length }}
            </p>
            <svg v-if="mostrarVotos" class="w-5 h-5 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
