    ...
    <nav class="bg-white border-gray-200  sticky top-0 z-50">
        ...
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            <div class="flex order-2">
                <button  type="button" data-collapse-toggle="navbar-search"  aria-controls="navbar-search" aria-expanded="false" class="lg:hidden text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-4 focus:ring-gray-200 rounded-lg text-sm p-2.5">
            ...
            <!-- Apartado de usuario -->
            <div class="flex items-center font-bold order-3">
            ...
            <div class="items-center justify-between hidden w-full md:flex md:w-auto text-center" id="mobile-menu-2">
