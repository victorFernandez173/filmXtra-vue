        ...
        <div class="p-6">
            <div id="navbar-search-mobile" class="w-full">
                <form @submit.prevent="submit" class="w-10/12 ml-[8.33%] mb-[23px] relative">
                    ...
                    <input @input="reactivarRetardoBusqueda" v-model="form.tituloBuscado" type="text" id="navbar-search-sm" class="w-full p-2 pl-10 text-sm text-gray-900 border-gray-300 bg-gray-50 border-[4px] focus:border-flamingo focus:ring-0" :placeholder="$page.props.errors.tituloBuscado ? $page.props.errors.tituloBuscado[0] : $t('navbar.busca')">
                </form>
            </div>
            ...
            <div class="col-span-full  text-center mt-2">
                <h2 v-if="resultados.numResultados > 0" class="text-2xl text-flamingo">
                    {{ resultados.numResultados }} {{ resultados.numResultados === 1 ?  $t('navbar.resultado') : $t('navbar.resultados') }}
                </h2>
                <h2 v-else class="text-2xl text-flamingo">
                    {{ $t('navbar.sin_resultados') }}
                </h2>
            </div>
            ...
            <div class="flex md:order-2 mr-3">
                <div id="navbar-search" class="relative hidden lg:block">
                    ...
                    <form @submit.prevent="submit">
                        <input @input="reactivarRetardoBusqueda" v-model="form.tituloBuscado" type="text" id="navbar-search-lg" class="block w-full p-2 pl-10 text-sm text-gray-900 border-gray-300 bg-gray-50 border-[4px] focus:border-flamingo focus:ring-0" :placeholder="$page.props.errors?.tituloBuscado ? $page.props.errors.tituloBuscado[0] : $t('navbar.busca')">
                    </form>
                </div>
            </div>
            <!-- Apartado de usuario -->
