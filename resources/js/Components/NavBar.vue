    ...
    <nav class="bg-white border-gray-200 sticky top-0 z-50">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between lg:mx-auto p-4 relative">
            ...
            <div class="flex items-center font-bold lg:order-2">
                <button type="button" class="absolute right-16 lg:right-4 flex text-sm bg-gray-800 rounded-full focus:ring-flamingo focus:ring-2 hover:ring-4 hover:ring-flamingo focus:flamingo" id="user-menu-button" aria-expanded="false" data-dropdown-toggle="user-dropdown" data-dropdown-placement="bottom">
                    <span class="sr-only">Abrir menú de usuario</span>
                    <img class="w-8 h-8 rounded-full" src="/favicon.png" alt="Foto del usuario">
                </button>
                <!-- Menu de usuario desplegable -->
                <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-300 rounded-lg shadow-3xl" id="user-dropdown">
                    <div class="px-4 py-3">
            ...
            <!-- Links -->
            <button data-collapse-toggle="mobile-menu-2" type="button" class="absolute right-3 inline-flex items-center p-2 text-sm text-gray-500 rounded-lg lg:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200" aria-controls="mobile-menu-2" aria-expanded="false">
            ...
            <div class="lg:order-1 items-center justify-between hidden w-full lg:flex lg:w-auto text-center" id="mobile-menu-2">
                <ul class="hover:[&>li>a]:text-flamingo flex flex-col font-medium p-4 lg:p-0 mt-4 rounded-lg lg:flex-row lg:space-x-8 lg:mt-0 lg:border-0 lg:bg-white [&>li>a]:block [&>li>a]:py-2 [&>li>a]:pl-3 [&>li>a]:pr-4 [&>li>a]:text-gray-900 lg:hover:[&>li>a]:bg-transparent lg:[&>li>a]:p-0">
                    <li>
                ...
                <div>
                    <div id="navbar-search" class="block md:hidden">
